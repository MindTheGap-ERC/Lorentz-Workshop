...
-   Work through the code, potentially modifying it according to your simulated stratigraphy from day 1 and the simulated tree from last chapter. What major differences do you see?
...
-   Niche preferences determine whether a taxon will be sampled at a specific location/time: If some environmental gradient matches the preferred environment of the taxon it is more likely to be observed. The more the environmental cline deviates from the optimum, the less likely an observation is
